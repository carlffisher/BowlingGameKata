...
namespace BowlingKata
{
    public class Tests
    {
        ...
        public void Test4()
        {
          ...
          //  bowlingkataclass.CalculateGameScore("X-X-X-X-X-X-X-X-X-X-", 0, 0).Should().Be(280);
             bowlingkataclass.CalculateGameScore("X-X-X-X-X-X-X-X-X-X-XX", 0, 0).Should().Be(300); // A full card ...
